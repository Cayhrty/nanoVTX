...
//--------------------------------------------------------------------------------
//Command: generate_target bd_882f.bd
//Design : bd_882f
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_882f,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_882f,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "top_mipi_csi2_rx_subsyst_0_0.hwdef" *) 
module bd_882f
   (csirxss_csi_irq,
  ...
  assign rx_m_axis_TREADY = video_out_tready;
  ...
  assign video_out_tdata[31:0] = rx_m_axis_TDATA;
  assign video_out_tdest[3:0] = rx_m_axis_TDEST;
  assign video_out_tkeep[3:0] = rx_m_axis_TKEEP;
  assign video_out_tlast = rx_m_axis_TLAST;
  assign video_out_tuser[0] = rx_m_axis_TUSER;
  assign video_out_tvalid = rx_m_axis_TVALID;
  bd_882f_phy_0 phy
