...
-- Command     : write_vhdl -force -mode funcsim -rename_top top_fft_config_0_0 -prefix
--               top_fft_config_0_0_ top_fft_config_0_0_sim_netlist.vhdl
...
entity top_fft_config_0_0 is
  ...
  attribute NotValidForBitStream of top_fft_config_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of top_fft_config_0_0 : entity is "top_fft_config_0_0,fft_config,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of top_fft_config_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of top_fft_config_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of top_fft_config_0_0 : entity is "fft_config,Vivado 2023.1";
end top_fft_config_0_0;

architecture STRUCTURE of top_fft_config_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_config_tvalid : signal is "XIL_INTERFACENAME m_axis_config, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 79999992, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
