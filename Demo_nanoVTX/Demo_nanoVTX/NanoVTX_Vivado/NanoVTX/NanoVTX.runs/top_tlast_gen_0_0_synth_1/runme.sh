...
HD_PWD='C:/FPGA/NanoVTX/NanoVTX.runs/top_tlast_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_tlast_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_tlast_gen_0_0.tcl
